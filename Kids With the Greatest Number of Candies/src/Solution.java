...
boolean array result of length n, where result[i] is true if, after giving the ith kid all the extraCandies, they will
...
public class Solution {
    ...
    public static void main(String[] args) {
        ...
        int m = in.nextInt();
        int[] candies = new int[m];  // array of primitive
