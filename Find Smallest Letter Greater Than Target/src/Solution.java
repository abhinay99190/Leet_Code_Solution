...
Example 1:-- Input:-- letters = ["c","f","j"], target = "a"
Output: "c"

Example 2:-- Input:-- letters = ["c","f","j"], target = "c"
Output: "f"

Example 3:-- Input:-- letters = ["c","f","j"], target = "d"
Output: "f"

Example 4:-- Input:-- letters = ["c","f","j"], target = "g"
Output: "j"

Example 5:-- Input:-- letters = ["c","f","j"], target = "j"
Output: "c"
